...
function getAccountNameFromUrl(url) {
    if (url.startsWith("http://127.0.0.1:10000")) {
        ...
        try {
            ...
            var accountName = url.substring(url.lastIndexOf("://") + 3, url.lastIndexOf(".blob."));
            if (!accountName) {
...
function createSpan(operationName, tracingOptions) {
    ...
    var spanOptions = tslib.__assign(tslib.__assign({}, tracingOptions.spanOptions), { kind: types.SpanKind.CLIENT });
